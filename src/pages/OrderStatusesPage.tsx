...
export default function OrderStatusesPage() {
  ...
  const handleSave = () => {
    ...
    setForm({
      ...
      description: "",
      isVisible: true,
      sortOrder: orderStatuses.length + 1,
    });
  };
    ...
    <div>
      ...
      <div className="p-6 space-y-4 animate-fade-in">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Manage and configure order status workflow
            </p>
          </div>
          <Dialog
            open={showCreate}
                  ...
                  <TableRow key={status.id}>
                    ...
                    <TableCell>
                      <Switch
                        ...
                        onCheckedChange={(v) =>
                          updateOrderStatus(status.id, { isVisible: v })
                        }
                        disabled={!isOwner}
                      />
                    </TableCell>
                    ...
                    <TableCell>
                      <div className="flex gap-1">
                        ...
                        <Button
                          ...
                          size="icon"
                          className="h-7 w-7"
                          onClick={() => setDeleteTargetId(status.id)}
                          disabled={!isOwner || status.isDefault}
                        >
        ...
        <ConfirmationDialog
          open={!!deleteTargetId}
          title="Delete Status"
          description="Delete this order status? This action cannot be undone."
          confirmLabel="Delete"
          tone="destructive"
          onOpenChange={(open) => {
          ...
          onConfirm={() => {
            ...
            deleteOrderStatus(deleteTargetId);
