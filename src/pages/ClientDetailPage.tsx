            ...
            <Card className="lg:col-span-3 lg:max-w-[320px] rounded-2xl border border-gray-100 shadow-sm overflow-hidden bg-white relative transition-all duration-300">
              ...
              <CardContent className="pt-0 -mt-10 px-4 py-4 space-y-4">
                ...
                <div className="text-center">
                  <div
                    className={`mx-auto h-20 w-20 rounded-full border-4 border-white ${getAvatarColor(
                      client.name,
                    )} shadow-lg flex items-center justify-center text-2xl font-bold text-white`}
                  >
                    {initials}
                  </div>
                  <h3 className="font-bold text-lg mt-3">{client.name}</h3>
                ...
                <div className="flex gap-2 pt-2">
                  <Button
                    size="sm"
                    className="flex-1 h-9 gap-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg"
                    onClick={() => setShowMail(true)}
                  >
