        ...
        <div className="relative z-10">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <p className="text-xl font-bold text-sidebar-primary-foreground">
            ...
            <div className="flex gap-2">
              {WORKFLOW_STEPS.map((_, i) => (
                <div
                  key={i}
                  className={`h-1.5 flex-1 rounded-full transition-all duration-500 ${i === activeStep ? "bg-white w-8" : "bg-white/20"}`}
                />
              ))}
            </div>
          </div>
          ...
          <div
            className={`mt-16 transition-all duration-700 delay-500 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
          >
            <p className="text-xs uppercase tracking-widest text-sidebar-foreground/50 mb-4 font-semibold">
              Enterprise Features
            </p>
