...
const DEFAULT_INTEGRATIONS: Integration[] = [
  ...
  },
  {
    ...
    name: "Dropbox",
    category: "Cloud Storage",
    description: "File hosting and storage",
    status: "not_connected",
    lastSync: "1h ago",
    icon: "📦",
    popular: false,
...
export default function IntegrationsPage() {
  ...
  const allFiltered = integrations.filter(
    (i) =>
  ...
  const handleDisconnect = (id: string) => {
    setIntegrations((prev) =>
      prev.map((i) =>
        i.id === id
          ? { ...i, status: "not_connected" as const, lastSync: undefined }
          : i,
      ),
    );
  ...
  const getStatusButton = (integration: Integration) => {
    switch (integration.status) {
      ...
      case "manage":
        return (
          <Badge
            className="bg-warning text-warning-foreground cursor-pointer"
            onClick={() => setShowConfig(integration.id)}
          >
            ● Manage
          </Badge>
      ...
      <div className="p-6 space-y-6 animate-fade-in">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Connect and manage third-party applications to automate workflows
              and sync data. Integrate with ERPs, accounting, payment gateways,
              e-invoicing, cloud storage, communication APIs.
            </p>
          </div>
          <div className="flex gap-2">
            ...
            <Button variant="outline" size="sm" className="gap-2">
              <RefreshCw className="h-4 w-4" /> Sync History
            </Button>
          </div>
        </div>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            >
              <Plus className="h-4 w-4" /> New Items
            </Button>
          </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewIntegration((p) => ({ ...p, name: e.target.value }))
                  }
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewIntegration((p) => ({ ...p, apiKey: e.target.value }))
                  }
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-muted-foreground">
                      {configIntegration.lastSync || "Never"}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <Label>Status</Label>
                    <Badge
                      className={
                        configIntegration.status === "connected"
                ...
                <div className="flex gap-2">
                  <Button
                    className="flex-1"
                    onClick={() => {
                      handleSync(configIntegration.id);
                      setShowConfig(null);
                    }}
                  >
                  ...
                  <Button
                    variant="destructive"
                    onClick={() => {
                      handleDisconnect(configIntegration.id);
                      setShowConfig(null);
                    }}
                  >
                    Disconnect
